...
public class AboutwhatWeCompletedFragment extends Fragment {

    private static final String TAG = "AboutwhatWeCompletedFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_about_wt_we_did, container, false);
