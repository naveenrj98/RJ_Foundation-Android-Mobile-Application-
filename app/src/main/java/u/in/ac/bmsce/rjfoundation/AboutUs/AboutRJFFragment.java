...
public class AboutRJFFragment extends Fragment {

    private static final String TAG = "AboutRJFFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_about_rj_foundation, container, false);
