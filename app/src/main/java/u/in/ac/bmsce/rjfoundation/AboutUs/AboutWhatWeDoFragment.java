...
public class AboutWhatWeDoFragment extends Fragment {

    private static final String TAG = "AboutWhatWeDoFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_about_wt_we_do, container, false);
